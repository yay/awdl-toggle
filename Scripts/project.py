...
def target(name, sources, bundle, product_type, product_path, extra, dependencies=(), embed=()):
...
for args in [
    ...
    }, ["AWDLControlExtension"], ["AWDLControlExtension"]),
...
configs = {
    "App-Info.plist": dict(base, CFBundlePackageType="APPL", CFBundleDisplayName="AWDL Toggle", NSPrincipalClass="NSApplication", NSHumanReadableCopyright="Includes AWDLControl code © 2026 James Howard (MIT)."),
